    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('prev_to_keep', models.DecimalField(blank=True, decimal_places=2, default=0, max_digits=12, null=True, verbose_name='prev_to_keep')),
                ('marketer_give_away', models.DecimalField(blank=True, decimal_places=2, default=0, max_digits=12, null=True, verbose_name='marketer_give_away')),
                ('marketer_to_keep', models.DecimalField(blank=True, decimal_places=2, default=0, max_digits=12, null=True, verbose_name='marketer_to_keep')),
            ],
            options={
                'abstract': False,
            },
