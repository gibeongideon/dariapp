    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('business', models.CharField(blank=True, help_text='Email where the money was sent.', max_length=127)),
                ...
                ('parent_txn_id', models.CharField(blank=True, max_length=19, verbose_name='Parent Transaction ID')),
                ('receiver_email', models.EmailField(blank=True, max_length=254)),
                ('receiver_id', models.CharField(blank=True, max_length=255)),
                ('residence_country', models.CharField(blank=True, max_length=2)),
                ('test_ipn', models.BooleanField(blank=True, default=False)),
                ('txn_id', models.CharField(blank=True, db_index=True, help_text='PayPal transaction ID.', max_length=255, verbose_name='Transaction ID')),
                ('txn_type', models.CharField(blank=True, help_text='PayPal transaction type.', max_length=255, verbose_name='Transaction Type')),
                ...
                ('address_country_code', models.CharField(blank=True, help_text='ISO 3166', max_length=64)),
                ('address_name', models.CharField(blank=True, max_length=128)),
                ('address_state', models.CharField(blank=True, max_length=40)),
                ('address_status', models.CharField(blank=True, max_length=255)),
                ...
                ('auth_status', models.CharField(blank=True, max_length=255)),
                ...
                ('mc_currency', models.CharField(blank=True, default='USD', max_length=32)),
                ...
                ('option_selection1', models.CharField(blank=True, max_length=200)),
                ('option_selection2', models.CharField(blank=True, max_length=200)),
                ('payer_status', models.CharField(blank=True, max_length=255)),
                ('payment_date', models.DateTimeField(blank=True, help_text='HH:MM:SS DD Mmm YY, YYYY PST', null=True)),
                ...
                ('pending_reason', models.CharField(blank=True, max_length=255)),
                ('protection_eligibility', models.CharField(blank=True, max_length=255)),
                ...
                ('transaction_entity', models.CharField(blank=True, max_length=255)),
                ('auction_buyer_id', models.CharField(blank=True, max_length=64)),
                ('auction_closing_date', models.DateTimeField(blank=True, help_text='HH:MM:SS DD Mmm YY, YYYY PST', null=True)),
                ...
                ('next_payment_date', models.DateTimeField(blank=True, help_text='HH:MM:SS DD Mmm YY, YYYY PST', null=True)),
                ('outstanding_balance', models.DecimalField(blank=True, decimal_places=2, default=0, max_digits=64, null=True)),
                ('payment_cycle', models.CharField(blank=True, max_length=255)),
                ('period_type', models.CharField(blank=True, max_length=255)),
                ('product_name', models.CharField(blank=True, max_length=255)),
                ('product_type', models.CharField(blank=True, max_length=255)),
                ('profile_status', models.CharField(blank=True, max_length=255)),
                ('recurring_payment_id', models.CharField(blank=True, max_length=255)),
                ('rp_invoice_id', models.CharField(blank=True, max_length=127)),
                ('time_created', models.DateTimeField(blank=True, help_text='HH:MM:SS DD Mmm YY, YYYY PST', null=True)),
                ...
                ('period3', models.CharField(blank=True, max_length=255)),
                ...
                ('retry_at', models.DateTimeField(blank=True, help_text='HH:MM:SS DD Mmm YY, YYYY PST', null=True)),
                ('subscr_date', models.DateTimeField(blank=True, help_text='HH:MM:SS DD Mmm YY, YYYY PST', null=True)),
                ('subscr_effective', models.DateTimeField(blank=True, help_text='HH:MM:SS DD Mmm YY, YYYY PST', null=True)),
                ('subscr_id', models.CharField(blank=True, max_length=19)),
                ('username', models.CharField(blank=True, max_length=64)),
                ('mp_id', models.CharField(blank=True, max_length=128, null=True)),
                ('case_creation_date', models.DateTimeField(blank=True, help_text='HH:MM:SS DD Mmm YY, YYYY PST', null=True)),
                ('case_id', models.CharField(blank=True, max_length=255)),
                ('case_type', models.CharField(blank=True, max_length=255)),
                ('receipt_id', models.CharField(blank=True, max_length=255)),
                ('currency_code', models.CharField(blank=True, default='USD', max_length=32)),
                ('handling_amount', models.DecimalField(blank=True, decimal_places=2, default=0, max_digits=64, null=True)),
                ('transaction_subject', models.CharField(blank=True, max_length=256)),
